#
#  Be sure to run `pod spec lint FaceDetectCamera.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "shayuan" => "shayuan@sensenets.com" }
  # Or just: s.author    = "shayuan"
  # s.authors            = { "shayuan" => "shayuan@sensenets.com" }
  # s.social_media_url   = "http://twitter.com/shayuan"
